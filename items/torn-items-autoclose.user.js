...
(function () {
    ...
    function autoClose() {
        ...
        // Confirm-helper sets this flag while cancelling to prevent a race where
        // auto-close fires during the confirmation→form transition and double-clicks close-act.
        if (sellDialog.dataset.tornCancelling) return;
